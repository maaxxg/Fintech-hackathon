...
<div class="rounded-none border border-red-100 bg-white p-4" id="filter-panel">
	...
	<div class="mb-4">
		<label
			for="search-filter"
			class="mb-1.5 block text-[10px] font-bold tracking-widest text-red-900/70 uppercase"
			>Search</label
		>
		<input
			id="search-filter"
	...
	<!-- Risk Score Range -->
	<div class="mb-4">
		<span class="mb-1.5 block text-[10px] font-bold tracking-widest text-red-900/70 uppercase"
			>Risk Profile</span
		>
